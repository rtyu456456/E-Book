...
public class UserDTO_T {
	...
	private int u_achievement_show;

	public UserDTO_T() {
		// TODO Auto-generated constructor stub
	}

	public UserDTO_T(String u_id, String u_pw, String u_name, String u_profile, String u_email, String u_gender,
			int u_age, int u_login, int u_login_streak, int u_login_total, String u_achievement,
			int u_achievement_show) {
		super();
		this.u_id = u_id;
		this.u_pw = u_pw;
		this.u_name = u_name;
	...
	public int getU_achievement_show() {
		return u_achievement_show;
	}

	public void setU_achievement_show(int u_achievement_show) {
		this.u_achievement_show = u_achievement_show;
	}

	@Override
	public String toString() {
		return "UserDTO_T [u_id=" + u_id + ", u_pw=" + u_pw + ", u_name=" + u_name + ", u_profile=" + u_profile
